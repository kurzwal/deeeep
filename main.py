...
if __name__ == "__main__":
    ...
    # num_hidden_layers = 5
    min_hidden_layers = 3
    max_hidden_layers = 8 # 3 ~ 7
    # =====================
    save_path = "./models/"
    save_extention = ".keras"

    model_name = "test_model2_0"  # Initial model name
    ...
    for i in range(num_iterations):
        ...
        num_hidden_layers = np.random.randint(min_hidden_layers, max_hidden_layers)
        ...
        if all([ev >= 0.45 for ev in evaluation]):
            ...
            print(model_name + save_extention + " has saved!")
            model_name = f"test_model2_{i + 1}"
